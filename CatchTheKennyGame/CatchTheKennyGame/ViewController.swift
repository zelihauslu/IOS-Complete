...
class ViewController: UIViewController {
    ...
    @objc func timeFunc() {
        ...
        if counter == 0{
            ...
            let alert = UIAlertController(title: "Hey, time's up!", message: "Do you want to play again?", preferredStyle: UIAlertController.Style.alert)
            ...
            let replayButton = UIAlertAction(title: "Replay", style: UIAlertAction.Style.default) { [self]
                ...
                self.timer = Timer.scheduledTimer(timeInterval: 1, target: self, selector:
                                                #selector(self.timeFunc), userInfo: nil, repeats: true)
                self.hideTimer = Timer.scheduledTimer(timeInterval: 0.5, target: self, selector:
                                                    #selector(self.hiddenKenny), userInfo: nil, repeats: true)
            }
